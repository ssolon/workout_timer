...
class _$Data implements Data {
  const _$Data({required this.name, this.description});
  ...
  @override
  String toString() {
    return 'RoutineState(name: $name, description: $description)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(name, description);
  }
...
abstract class Data implements RoutineState {
  const factory Data({required final String name, final String? description}) =
      _$Data;
