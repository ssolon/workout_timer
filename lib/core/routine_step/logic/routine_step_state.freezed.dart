...
part of 'routine_step_state.dart';
...
mixin _$RoutineStepState {
  ...
  Duration? get timeTo => throw _privateConstructorUsedError;
...
class _$_StepState implements _StepState {
  ...
  @override
  String toString() {
    return 'RoutineStepState(name: $name, description: $description, beginAction: $beginAction, timer: $timer, timeTo: $timeTo)';
  }
...
abstract class _StepState implements RoutineStepState {
  const factory _StepState(
      ...
      final BeginAction beginAction,
      final StepTimer timer,
      final Duration? timeTo}) = _$_StepState;
